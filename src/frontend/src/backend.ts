...
export class Backend implements backendInterface {
    ...
    async listAllQuotes(): Promise<Array<[QuoteId, Quote]>> {
        if (this.processError) {
            try {
                const result = await this.actor.listAllQuotes();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveQuote(arg0: string, arg1: string, arg2: bigint): Promise<QuoteId> {
        if (this.processError) {
            try {
                const result = await this.actor.saveQuote(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
